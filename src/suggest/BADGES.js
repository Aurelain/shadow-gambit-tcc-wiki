export const LOC_MORROWS_REACH = "Morrow's Reach";
export const LOC_NEW_KRUCBURY = 'New Krucbury';
export const LOC_IRON_BAY = 'Iron Bay';
export const LOC_TWINS = 'Twins of Nerechtemeresch';
export const LOC_ISLE_OF_PENANCE = 'Isle of Penance';
export const LOC_DREAD_VINE = "Dread Vine's Cove";
export const LOC_GRAN_ALCAZAR = 'Gran Alcázar';
export const LOC_ANGLERS_GRAVE = "Angler's Grave";
export const LOC_CALAMITY_REEF = 'Calamity Reef';
export const LOC_MEMORY = 'Memory of the Grand Design';

export const MIS_RED_MARLEY_RISING = 'Red Marley Rising';
export const MIS_A_SHIP_NEEDS_A_CREW = 'A Ship Needs a Crew';
export const MIS_THE_CAPTAINS_TREASURE = "The Captain's Treasure";
export const MIS_GAELLES_LETTER_CH3 = "Gaëlle's Letter (Ch. 3)";
export const MIS_FRAGMENTS = 'Fragments';
export const MIS_SNATCHED_FROM_THE_PIT = 'Snatched From the Pit';
export const MIS_PINKUS_DUTY_CH1 = "Pinkus' duty (Ch. 1)";
export const MIS_ASH_AND_ORE = 'Ash and Ore';
export const MIS_TERESAS_LAMENT_CH1 = "Teresa's Lament (Ch. 1)";
export const MIS_QUENTINS_HUNT_CH2 = "Quentin's Hunt (Ch. 2)";
export const MIS_PREPARE_FOR_TROUBLE = 'Prepare for Trouble';
export const MIS_JOHNS_REVENGE_CH1 = "John's Revenge (Ch. 1)";
export const MIS_BONE_AND_FINGERS = 'Bone and Fingers';
export const MIS_FRUITS_OF_HER_LABOR = 'Fruits of Her Labor';
export const MIS_BARK_AND_BRAMBLE = 'Bark and Bramble';
export const MIS_HAGGLING_WITH_A_PLANT = 'Haggling With a Plant';
export const MIS_SULEIDYS_CURE = "Suleidy's Cure";
export const MIS_INTO_THE_LIONS_DEN = "Into the Lion's Den";
export const MIS_IGNACIA_UNLEASHED = 'Ignacia Unleashed';
export const MIS_PINKUS_DUTY_CH2 = "Pinkus's Duty (Ch. 2)";
export const MIS_TERESAS_LAMENT_CH2 = "Teresa's Lament (Ch. 2)";
export const MIS_GRAVEYARD_HAUNT = 'Graveyard Haunt';
export const MIS_THE_KUMQUAT_CONNECTION = 'The Kumquat Connection';
export const MIS_GAELLES_LETTER_CH2 = "Gaëlle's Letter (Ch. 2)";
export const MIS_JOHNS_REVENGE_CH2 = "John's Revenge (Ch. 2)";
export const MIS_TOYAS_PERFECTION_CH1 = "Toya's Perfection (Ch. 1)";
export const MIS_LIGHTHOUSE_LOCUTIONS = 'Lighthouse Locutions';
export const MIS_SMALL_CREW_BIG_PLANS = 'Small Crew, Big Plans';
export const MIS_GAELLES_LETTER_CH1 = "Gaëlle's Letter (Ch. 1)";
export const MIS_TOYAS_PERFECTION_CH2 = "Toya's Perfection (Ch. 2)";
export const MIS_QUENTINS_HUNT = "Quentin's Hunt";
export const MIS_MEASURE_IS_UNCEASING = 'Measure Is Unceasing';

export const CREW_AFIA = 'Afia';
export const CREW_SULEIDY = 'Suleidy';
export const CREW_PINKUS = 'Pinkus';
export const CREW_TERESA = 'Teresa';
export const CREW_TOYA = 'Toya';
export const CREW_QUENTIN = 'Quentin';
export const CREW_GAELLE = 'Gaëlle';
export const CREW_JOHN = 'John';
